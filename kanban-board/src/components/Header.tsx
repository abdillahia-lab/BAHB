        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={filterRef}>
              ...
              {showFilters && (
                <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-4 z-50 animate-scale-in">
                        ...
                        <button
                          ...
                          className={`px-2 py-1 text-xs font-medium rounded-full transition-all ${
                            filterLabels.includes(label.id)
                              ? `${labelColors[label.color].bg} text-white ring-2 ring-offset-1`
            ...
            <div className="relative" ref={shortcutsRef}>
              ...
              {showShortcuts && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-4 z-50 animate-scale-in">
